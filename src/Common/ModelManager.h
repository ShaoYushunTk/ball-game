...
{   public:
    ...
    PxRigidActor* m_rigidActor = NULL;
    ...
    void SetPhysicsData(PxRigidActor* rigidActor){ m_rigidActor = rigidActor; }
    PxRigidActor* GetPhysicsData() const { return m_rigidActor; }
};
...
public:
    ...
    Model* CreateFromGeometry(int id, const GeometryData& data, bool isDynamic = false);
    Model* CreateFromGeometry(std::string_view name, const GeometryData& data, bool isDynamic);
